...
const MISSIONS = [
  {
    ...
    sectorZones: [
      { lat: 500, lng: 960, label: 'DATA SCIENCE CORE', tag:'// ACADEMIC NODE', holo: {
        ...
        img: 'ds_core.jpg', why: 'Master computational mathematics and foundational CS principles.', 
      ...
      { lat: 700, lng: 1400, label: 'ELITE CODERS RELAY', tag:'// LEADERSHIP', holo: {
        ...
        img: 'elite.jpg', why: 'Scale developer ecosystems and deploy robust credentialing across India.', 
  ...
  
  {
    ...
    sectorZones: [
      { lat: 700, lng: 400, label: 'PROJECT INDRA-AI', tag:'// UAV VISION', holo: {
        ...
        img: 'indra.jpg', why: 'Automate fatal manual inspections of transmission lines for predictive grid maintenance.', 
      ...
      { lat: 400, lng: 1000, label: 'FLOWSYNC-AI', tag:'// URBAN TRAFFIC', holo: {
        ...
        img: 'flowsync.jpg', why: 'Eradicate emergency vehicle delays caused by static timers.', 
      ...
      { lat: 600, lng: 1300, label: 'DATASENTINEL AI', tag:'// DATA GOVERNANCE', holo: {
        ...
        img: 'datasentinel.jpg', why: 'Prevent silent schema failures and compliance risks in enterprise databases.', 
      ...
      { lat: 800, lng: 900, label: 'FIX-IT-NOW AI', tag:'// CIVIC OPS', holo: {
        ...
        img: 'fixit.jpg', why: 'Manual civic grievance routing causes critical public infrastructure response delays.', 
...

  {
    ...
    sectorZones: [
      { lat: 600, lng: 500, label: 'PROMPTLY AI PVT LTD', tag:'// AI RESEARCH INTERN', holo: {
        ...
        img: 'promptly.jpg', why: 'Evaluate B2B AI tools and mitigate enterprise legal liability.', 
      ...
      { lat: 400, lng: 1100, label: 'EMPYREAN ROBOTICS', tag:'// SDE AI/ML INTERN', holo: {
        ...
        img: 'empyrean.jpg', why: 'Develop real-world computer vision monitoring infrastructure.', 
      ...
      { lat: 800, lng: 900, label: 'GOOGLE GSA', tag:'// PAN-INDIA OPS HEAD', holo: {
        ...
        img: 'google.jpg', why: 'Automate manual coordination for 110+ campus leads globally.', 
...

  {
    ...
    sectorZones: [
      { lat: 500, lng: 600, label: 'CORE & MATHEMATICS', tag:'// THE BRAIN', holo: {
        ...
        img: 'math.jpg', why: 'Provide robust logic and low-level memory management.', 
      ...
      { lat: 700, lng: 1200, label: 'AI & PERCEPTION', tag:'// THE EYES', holo: {
        ...
        img: 'vision.jpg', why: 'Enable high-fidelity spatial and contextual awareness.', 
      ...
      { lat: 400, lng: 1400, label: 'EDGE INFRASTRUCTURE', tag:'// THE SPINE', holo: {
        ...
        img: 'infra.jpg', why: 'Ensure zero-downtime, cloud-independent execution.', 
...

  {
    ...
    sectorZones: [
      { lat: 400, lng: 600, label: 'PROJECT VYUHA', tag:'// CLASSIFIED SWARM', holo: {
        ...
        img: 'vyuha.jpg', why: 'Eliminate Single Point of Failure (SPOF) in drone swarms.', 
      ...
      { lat: 700, lng: 1100, label: 'A.V.A.T.A.R', tag:'// 60FPS KINEMATICS', holo: {
        ...
        img: 'avatar.jpg', why: 'Real-time spatial mapping without cloud ping.', 
      ...
      { lat: 600, lng: 1500, label: 'MAYA PROTOCOL', tag:'// BEHAVIORAL SIM', holo: {
        ...
        img: 'maya.jpg', why: 'Model physiological consequences of dopamine choices.', 
      ...
      { lat: 800, lng: 400, label: 'NAAD PROTOCOL', tag:'// DATA STREAMING', holo: {
        ...
        img: 'naad.jpg', why: 'Traditional waveform streaming wastes network bandwidth.', 
...

  {
    ...
    sectorZones: [
      { lat: 400, lng: 800, label: 'DEFENSE AI ARCHIVE', tag:'// AUTOMATION', holo: {
        ...
        img: 'archive.jpg', why: 'Aggregate global defense-tech and swarm publications.', 
      ...
      { lat: 700, lng: 1200, label: 'GCB-HUB DEPLOYMENT', tag:'// WEB PIPELINE', holo: {
        ...
        img: 'gcb.jpg', why: 'Deploy petabyte-scale genetic models (BLISS) for global access.', 
